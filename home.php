<div id="content">
    ...
    <div class="col">
      <div class="blocktitle">
        <div class="tabs" data-target="#phim-bo-hay">
          <div class="tab active" data-name="phim-bo-moi">Phim Lẻ Trong Tuần</div>
          <div class="tab" data-name="phim-bo-full">Phim Bộ Trong Tuần</div>
        </div>
      </div>
      <div class="blockbody" id="phim-bo-hay">
        <ul class="list tab phim-bo-moi">
          <?php
            $sql = 'select * from `film` where `type_movie` = 1 order by `num_view` DESC limit 4';
        ...
        <ul class="list tab phim-bo-full hide">
          <?php
            $sql = 'select * from `film` where `type_movie` = 2 order by `num_view` DESC limit 4';
            $query = mysqli_query($link, $sql);
            while($r=mysqli_fetch_assoc($query)){
          ?>
            <li><a href="?mod=detail&film_id=<?php echo $r['id'] ?>" title="<?php echo $r['name'] ?>"><?php echo $r['name'] ?></a><span><?php echo $r['status'] ?></span></li>
  ...
  <div class="block" id="movie-update">
    <div class="blocktitle">
      ...
      <h3 class="title">Phim mới</h3>
      <div class="types" data-target="#list-movie-update">
        <div class="type"><a data-name="toan-bo" class="btn active">Tổng Hợp</a></div>
        <div class="type"><a data-name="phim-le" class="btn" href="javascript:void();" title="Phim lẻ">Phim lẻ mới</a></div>
        <div class="type"><a data-name="phim-bo" class="btn" href="javascript:void();" title="Phim bộ">Phim bộ mới </a></div>
      </div>
    </div>
    <div class="blockbody" id="list-movie-update">
      ...
      <div class="tab phim-le hide">
        <ul class="list-film tab phim-le">
          <?php
            $sql = 'select * from `film` where `type_movie` = 1 order by `id` DESC limit 8';
            $query = mysqli_query($link, $sql);
            while($r=mysqli_fetch_assoc($query)){
          ?>
      ...
      <div class="tab phim-bo hide">
        <ul class="list-film">
          <?php
            $sql = 'select * from `film` where `type_movie` = 2 order by `id` DESC limit 8';
            $query = mysqli_query($link, $sql);
            while($r=mysqli_fetch_assoc($query)){
          ?>
            <li data-liked="3,987" data-views="94,650">
  ...
  <div class="block">
    <div class="blocktitle">
      <div class="icon movie1"></div>
      <h3 class="title"><a title="PHIM HÀNH ĐỘNG" href="javascript:void();"> TOP PHIM HÀNH ĐỘNG</a></h3>
  ...
  <div class="block">
    <div class="blocktitle">
      <div class="icon movie1"></div>
      <h3 class="title"><a title="PHIM BỘ MỚI" href="javascript:void();">TOP TV SHOW</a></h3>
      <div class="more"><a href="?mod=list&type=category&id=8">Xem thêm</a> »</div>
    </div>
    <div class="blockbody" id="list-movie-update">
      <div class="tab">
        <ul class="list-film tab">
  ...
  <div class="block">
    <div class="blocktitle">
      <div class="icon movie1"></div>
      <h3 class="title"><a title="PHIM BỘ MỚI" href="javascript:void();"> TOP PHIM HOẠT HÌNH</a></h3>
      <div class="more"><a href="?mod=list&type=category&id=6">Xem thêm</a> »</div>
    </div>
    <div class="blockbody" id="list-movie-update">
      <div class="tab">
        <ul class="list-film tab">
          <?php
            $sql = 'select * from `film` where `category_id` = 6 order by `id` DESC limit 4';
            $query = mysqli_query($link, $sql);
            while($r=mysqli_fetch_assoc($query)){
          ?>
          <li data-liked="238" data-views="33,450">
