...
<div id="content">
  <div class="block" id="page-info">
    <div class="blocktitle breadcrumbs">
        <div class="item">
            <a href="?mod=home" title="Xem Phim Nhanh, Xem Phim Online chất lượng cao miễn phí tại KingFilm">
                <span>Xem phim</span>
            </a>
        </div>
        <div class="item">
        ...
        <div class="dinfo">
            <div class="col1 fr">
                <ul>
                    ...
                    <li>Thể loại: <a href="the-loai/phim-hanh-dong/" title="Phim Hành Động"> <?php echo $r['type_movie'] ?></a></li>
                </ul>
            </div>
            <div class="col2">
                <ul>
