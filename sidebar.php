<div id="sidebar">
  <div class="block" id="chart">
    ...
    <div class="tabs" data-target="#topview">
      <div id="topviewday" class="tab active">Phim lẻ Hay</div>
      <div id="topviewweek" class="tab">Phim bộ Hay</div>
      <div id="topviewmonth" class="tab">Phim Rạp Hay</div>
    </div>
    <div class="blockbody" id="topview">
      ...
      <ul class="tab topviewmonth hide">
        <?php
          $sql = 'select * from `film` where `type_movie` = 3 order by `num_view` DESC limit 8';
          $query = mysqli_query($link, $sql);
          while($r=mysqli_fetch_assoc($query)){
        ?>
